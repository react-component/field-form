...
describe('Form.List', () => {
  ...
  const generateForm = (
  ...
  ): readonly [container: HTMLElement, getField: () => HTMLElement] => {
    ...
    return [container, () => container.querySelector('.list')] as const;
  };
  ...
  it('operation', async () => {
    ...
    const [container, getList] = generateForm((fields, opt) => {
      operation = opt;
      return (
        <div>
          {fields.map(field => (
